...
const Auth = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    .catch(err=>alert('Something went Wrong, Please ensure correct credentials'));
    ...
    if(isSignup){
      cookies.set('hashedPassword', hashedPassword, cookieOptions);
      cookies.set('avatarURL', avatarURL, cookieOptions);
